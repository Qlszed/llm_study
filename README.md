...
- `TWR.py` - This script computes the word count and token count of each prompt using each model’s tokenizer, then calculates the Token-to-Word Ratio (TWR) for each prompt.
